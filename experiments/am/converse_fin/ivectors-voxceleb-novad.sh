...
# ivectordir=exp/nnet3${nnet3_affix}/ivectors_${train_set}_hires_voxceleb 
...
# perturbation (sp).
for data in ${train_set} ${test_sets}; do
  # nspk=$(wc -l <data/${data}_hires/spk2utt)
  steps/nnet/ivector/extract_ivectors.sh --cmd "$train_cmd" --nj 1 \
