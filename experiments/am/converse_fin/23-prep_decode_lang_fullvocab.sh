...
# training lang dir
lang=data/lang_fullvocab_nosp

# new lang dir used for decoding
dir=data/lang_test_word_fullvocab_nosp
...
# with the fullvocab, there should be no OOVs
# so trying to find&remove them is redundant but left here for sanity check 
